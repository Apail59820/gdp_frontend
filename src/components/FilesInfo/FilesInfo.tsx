...
const FileInfo = ({isOpen, setIsOpen , disableEdition, setEditButtonState, file} : FileInfoProps) => {
    ...
    return (
        ...
        >
            ...
            <div className={styles.frame}>
                <div className={styles.linksContainer} style={{display: "flex", alignItems: "center"}}>
                    {!disableEdition && (
                        <div style={{display: "flex", alignItems: "center", marginLeft: "8px"}}>
                            ...
                            <Link href={"#"} onClick={handleModify} style={{marginLeft: "3px"}}>Modifier le fichier</Link>
                        </div>
                    )}
                    <div style={{display: "flex", alignItems: "center", marginLeft: "8px"}} color={'danger'}>
                        <svg width="12" height="12" viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg">
